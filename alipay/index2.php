...
//define('mybasedir', __FILE__);
ini_set('date.timezone','Asia/Shanghai');
//error_reporting(E_ERROR);

require_once $mybasedir."/lib2/WxPay.Api.php";
require_once $mybasedir."/example/WxPay.NativePay.php";
require_once $mybasedir."/example/log.php";
...
$input->SetNotify_url("http://deguanjiaoyu.com/alipay/notify.php");
...
<body>
	...
	saa<?php echo urlencode($url2);?>213
</body>
</html>