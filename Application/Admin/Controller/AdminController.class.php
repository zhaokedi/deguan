...
class AdminController extends Controller {
    ...
    protected function _initialize(){
        ...
        $agentinfo=M('auth_group_access')->where(array('uid'=>UID,'group_id'=>6))->find();
        $adminuser=M('ucenter_member')->where(array('id'=>UID))->find();
//        dump($adminuser);
        $isagent= $agentinfo?1:0;
...
//        dump($this->getMenus());
        ...
        $agentinfo['isagent']=$isagent;
        $agentinfo['province']=$adminuser['province'];
