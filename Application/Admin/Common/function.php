 ...
 *
 */
function int_to_string(&$data,$map=array('status'=>array(1=>'正常',-1=>'删除',0=>'禁用',2=>'未审核',3=>'草稿')), $type = 1) {
 ...
 * @author huajie <banhuajie@163.com>
 */
function get_dealed_title($is_dealed = null){
    if(!isset($is_dealed)){
        return false;
    }
    switch ($is_dealed){
        case 1  : return    '已处理';     break;
        case 2  : return    '未处理';   break;
        default : return    false;      break;
    }
}
 ...
 * @author huajie <banhuajie@163.com>
 */
function get_forbidden_title($is_forbidden = null){
    if(!isset($is_forbidden)){
        return false;
    }
    switch ($is_forbidden){
        case 1  : return    '已屏蔽';     break;
        case 2  : return    '未屏蔽';   break;
        default : return    false;      break;
    }
}
 ...
 * @author huajie <banhuajie@163.com>
 */
function get_service_title($service_type = null){
 ...
 * @author huajie <banhuajie@163.com>
 */
function get_orderstatus_title($status = null){
    if(!isset($status)){
        return false;
    }
    $data = C('ORDER_STATUS');
 ...
 * @author huajie <banhuajie@163.com>
 */
function get_withdrawstatus_title($status = null){
    if(!isset($status)){
        return false;
    }
    $data = C('WITHDRAW_STATUS');
    return $data[$status];
}