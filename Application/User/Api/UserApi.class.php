...
class UserApi extends Api{
     ...
     */
    public function register($username, $password, $email, $mobile = '',$province='',$city='',$state='',$agent_level){
        return $this->model->register($username, $password, $email, $mobile,$province,$city,$state,$agent_level);
    }
